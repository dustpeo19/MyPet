...
dogs[2] = {
    ...
    description: '저먼 셰퍼드는 영리하고 분별력 있는 강아지다. 당신과 마찬가지로 끈기 있고 정의로운 성격이다. 용맹하고 충성심 높은 저먼 셰퍼드는 성실하고 영감이 솟아오르는 당신과 함께할 때 최고의 시너지를 낼 것이다.',
    activity: 4,
    attract: 2,
    intimacy: 3,
    loyalty: 4,
...
dogs[4] = {
    ...
    description: '프렌치 불독은 활달하고 명랑하며 믿음직스러운 강아지다. 혈기 왕성하고 사랑스러운 매력을 가지고 있다. 만능 재주꾼이며 팔방미인인 당신과 활동적이고 모험심 강한 프렌치 불독이 함께라면 무서울 게 없을 것이다!',
    activity: 5,
    attract: 3,
    intimacy: 5,
    loyalty: 4,
...
cats[3] = {
    ...
    description: '노르웨이 숲 고양이는 똑똑한 고양이로, 훈련을 시키기도 쉽고 여러운 장난감도 잘 가지고 논다. 진지한 생각을 자주 하는 당신과 마찬가지로 공상을 자주 하는 듯하다. 친화력은 좋지만 독립적인 성격이라 찰싹 붙어 있지는 않는다.',
    activity: 4,
    attract: 2,
    intimacy: 4,
    loyalty: 3,
...
cats[10] = {
    name: '싱가퓨라',
    ename: 'Singapura',
    description: '싱가퓨라는 호기심이 많아 장난을 좋아하며 사람을 잘 따르는 귀여운 고양이다. 똑똑해서 어느 정도의 훈련도 가능하다. 매우 활동적이면서도 사교적이며 열정 넘치는 싱가퓨라는 밝고 활기찬 당신과 찰떡궁합! 집사가 휴식을 취할 때는 집사 옆에서 떨어지지 않는 사랑스러운 모습도 보인다.',
    activity: 5,
    attract: 4,
    intimacy: 4,
    loyalty: 5,
...
cats[11] = {
    name: '발리니즈',
    ename: 'Balinese',
    description: '발리니즈는 매우 영리하며 외향적이고 활발한 고양이로, 다재다능하고 팔방미인형인 당신과 아주 잘 어울린다. 호기심이 많고 똑똑하여 주변에 관심이 많고 새로운 것을 빨리 배운다. 공격적이지 않고 온화하여 아이들이나 다른 동물들과도 잘 지내다 보니 많은 사람들에게 사랑받는 고양이다.',
    activity: 4,
    attract: 4,
    intimacy: 5,
    loyalty: 3,
